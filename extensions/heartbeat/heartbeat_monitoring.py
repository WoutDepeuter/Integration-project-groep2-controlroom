...
from env import RABBITMQ_HOST, RABBITMQ_USER, RABBITMQ_PASS, RABBITMQ_VHOST, RABBITMQ_PORT, RABBITMQ_EXCHANGE, \
    RABBITMQ_ROUTING_KEY, RABBITMQ_CHANNEL, ADMIN_EMAILS
